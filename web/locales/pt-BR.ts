...
export const ptBR: Translations = {
    ...
    settings: {
        ...
        portrait: "Retrato (1080×1920)",
        portrait1440: "Retrato (1440×2560)",
        portraitHint: "Esta é uma resolução em retrato. Defina a Orientação em Tela Cheia como Retrato ou Automático para preencher uma tela vertical.",
        ...
        fullscreenOrientation: "Orientação em Tela Cheia",
        orientationLandscape: "Paisagem",
        orientationPortrait: "Retrato",
        orientationAuto: "Automático (Seguir Dispositivo)",
        style: "Estilo",
