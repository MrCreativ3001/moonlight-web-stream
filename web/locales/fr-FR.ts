...
export const frFr: Translations = {
    ...
    settings: {
        ...
        portrait1440: "Portrait (1440×2560)",
        portraitHint: "Il s'agit d'une résolution portrait. Réglez l'orientation en plein écran sur Portrait ou Auto pour remplir un écran vertical.",
        ...
        fullscreenOrientation: "Orientation en plein écran",
        orientationLandscape: "Paysage",
        orientationPortrait: "Portrait",
        orientationAuto: "Auto (suivre l'appareil)",
        style: "Style",
