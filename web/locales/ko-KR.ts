...
export const koKR: Translations = {
    ...
    settings: {
        ...
        native: "기본값",
        custom: "사용자 정의",
        portrait: "세로 (1080×1920)",
        portrait1440: "세로 (1440×2560)",
        portraitHint: "세로 해상도입니다. 세로 화면을 채우려면 전체화면 방향을 세로 또는 자동으로 설정하세요.",
        videoWidth: "화면 너비",
        videoHeight: "화면 높이",
        ...
        fullscreenOrientation: "전체화면 방향",
        orientationLandscape: "가로",
        orientationPortrait: "세로",
        orientationAuto: "자동 (기기 방향 따름)",
        style: "스타일",
